...
function isStraight(hList: NormalizedLandmarkList[], f: number, bar: number): boolean {
...
function onResults(
    ...
    for (let k in res.multiHandedness) {
        ...
        let allStraight: boolean = true, allAbove: Boolean = true;
        for (let i = 1; i < 5; ++i) {
            if (!isStraight(hList, i, eraseBar)) { allStraight = false; }
